    ...
    describe('#onSubmit', function () {
        ...
        describe('form submit', function () {
            ...
            it('subscribes to model invalid event once', function () {
                expect(stubbedSubscribeModelInvalidEvent).to.have.been.calledWith(model, view.$el);
            });
...
describe('Views.Membership', function () {
    ...
    describe('new', function () {
        ...
        it('subscribes to showMembership application event', function () {
            expect(spiedListenTo).to.have.been.calledWith(Application.events, 'showMembership', view.onShowMembership);
        });
        it('subscribes to signedIn passwordResetRequested and signedUp application events', function () {
            expect(spiedListenTo).to.have.been.calledWith(Application.events, 'signedIn passwordResetRequested signedUp', view.onSignedInOrPasswordResetRequestedOrSignedUp);
        });
    });
