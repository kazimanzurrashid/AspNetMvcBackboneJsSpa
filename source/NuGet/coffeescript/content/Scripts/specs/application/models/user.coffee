...
describe 'Models.User', ->
  ...
  describe '#defaults', ->
    it 'has email',  -> expect(user.defaults()).to.have.property 'email'

    it 'has password', -> expect(user.defaults()).to.have.property 'password'

    it 'has confirmPassword', ->
      expect(user.defaults()).to.have.property 'confirmPassword'

  describe '#urlRoot', ->
    it 'is set', -> expect(user.urlRoot()).to.exist
  ...
  describe 'validation', ->
    ...
    describe 'valid', ->
      ...
      it 'is ok', -> expect(user.isValid()).to.be.ok
