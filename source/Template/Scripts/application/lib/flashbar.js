(function ($, _) {
    ...
    var template = _.template('<div class="alert alert-{{type}} fade.in flash-bar hide">' + '<button type="button" class="close" data-dismiss="alert" title="close">&times;</button>' + '<i class="{{icon}}"></i> ' + '<span>{{message}}</span>' + '</div>');
